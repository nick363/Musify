...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let plistFilePathInDocumentDirectory = documentDirectoryPath + "/MusicGenres.plist"
        ...
        if let dictionaryFromFileInDocumentDirectory = dictionaryFromFile {
            ...
            dict_MusicGenres = dictionaryFromFileInDocumentDirectory
            
            genreNames = dict_MusicGenres.allKeys as! [String]
            genreNames.sort { $0 < $1 }
            ...
            let plistFilePathInMainBundle = Bundle.main.path(forResource: "MusicGenres", ofType: "plist")
            
            // Instantiate an NSMutableDictionary object and initialize it with the contents of the CountryCities.plist file.
            let dictionaryFromFileInMainBundle: NSMutableDictionary? = NSMutableDictionary(contentsOfFile: plistFilePathInMainBundle!)
            
            // Store the object reference into the instance variable
            dict_MusicGenres = dictionaryFromFileInMainBundle!
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        dict_MusicGenres.write(toFile: plistFilePathInDocumentDirectory, atomically: true)
